...
public class UserWorkRateService {
	...
	public List<UserWorkRateDTO> list() {
		return userWorkRateTransformation.transformToApi(userWorkRateDAO.findAll());
	}

	@Transactional
	public void saveOrUpdate(UserWorkRateDTO userWorkRate) {
		userWorkRateDAO.save(userWorkRateTransformation.transformToModel(userWorkRate));
	}

	@Transactional
	public void delete(UserWorkRateDTO userWorkRate) {
		userWorkRateDAO.delete(userWorkRateTransformation.transformToModel(userWorkRate));
	}
