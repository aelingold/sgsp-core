		...
		<form name="ELEorderForm" id="ELEorderForm" action="<@c.url value='/place-order' />" method="POST" enctype="utf8">
			...
			<div class="row">
				<div class="col-md-12">
					<div style="text-align: center;position:relative;">
						...
						<span class="selected-work-area">Necesito un Electricista</span>						
					</div>					
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					<label>
						<#list workAreaQuestions as workAreaQuestion>
							<#if workAreaQuestion.workAreaCode="ELE" && workAreaQuestion.groupType='WORK'>
				...
				<div class="col-md-6">
					<label>
						<#list workAreaQuestions as workAreaQuestion>
							<#if workAreaQuestion.workAreaCode="ELE" && workAreaQuestion.groupType='PROPERTY'>
								${workAreaQuestion.description}							
							</#if>
						</#list>
					</label>				        				
			...
			<div class="row">
				<div class="col-md-12">
					<label>
						<#list workAreaQuestions as workAreaQuestion>
							<#if workAreaQuestion.workAreaCode="ELE" && workAreaQuestion.groupType='ARTIFACT'>
								${workAreaQuestion.description}							
							</#if>
						</#list>
					</label>				        					        				
			...
			<div class="row" style="margin-bottom: 0px">
				<div class="col-md-12">    
					<a href="javascript:document.ELEorderForm.submit();" class="btn btn-md btn-primary pull-right">Aceptar</a>
				</div>
			</div>
		</form>
	</div>
